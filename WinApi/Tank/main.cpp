...
HINSTANCE g_hInstance;	// 프로그램  인스턴스 , 프로그램 자체의 핸들
HWND g_hWnd;  //핸들 윈도우 , 프로그램안 윈도우 창의 번호
	...
	LPSTR lpszCmdParam, int nCmdShow)
{
	...
	AdjustWindowRect(&rcWindowSize, WS_OVERLAPPEDWINDOW, FALSE); //(RECT구조체에 대한 포인터, 창스타일, 창에 메뉴가 있는지여부)
	int width = rcWindowSize.right - rcWindowSize.left;         //윈도우 창사각형 계산
